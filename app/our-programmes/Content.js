...
<div class="accordion accordion-flush" id="accordionFlushExample">
  ...
  <div class="accordion-item">
    ...
    <div id="flush-collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
      <div class="accordion-body">We provide technical support to strengthen workplace systems, processes and practices. We support the factories to strengthen their policies and workplace committees to improve social dialogue, promote workers’ rights and well-being, prevention and redressal against sexual harassment.</div>
    </div>
    </div>
    <div class="accordion-item">
    <h2 class="accordion-header">
    ...
    <div id="flush-collapseFive" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                              <div class="accordion-body">We work with Street Vendors’ Associations and civil society organisations to support and enhance health & digital financial inclusion of street vendors across India. We have reached more than 300,000 street vendors so far. We also supported MEPMA–Government of Telangana to strengthen their efforts towards Street vendors’ well-being on ground during the COVID-19 pandemic in 2021, which was appreciated by the state government. We conceptualised interventions such as “Smart Vending” for street vendors to protect them during the pandemic and established the inter-connectivity between health and livelihoods.</div>
                              <div class="accordion-body">The Street Vendor organisations have been actively working on COVID prevention, care and management, vaccination, awareness on social protection schemes and digital financial literacy along with relief support (nutrition, hygiene kits, personal protective equipment and medical equipment).</div>
    </div>
                      </div>
                      <div class="accordion-item">
    <h2 class="accordion-header">
    ...
    <div id="flush-collapseSix" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
      <div class="accordion-body">Our work with community health workers entails improving systems to support the community health workers. Our life skills & leadership-based programme ‘Parivartan’, with Swasti’s i4We front line well-being workforce, led to an empowering community-led health workforces.</div>
    </div>
  </div>
