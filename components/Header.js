...
<div class="offcanvas offcanvas-start up-bg" data-bs-backdrop="static" tabindex="-1" id="staticBackdrop" aria-labelledby="staticBackdropLabel">
  <div class="offcanvas-header">
<button type="button" class="btn-close btn-bg" data-bs-dismiss="offcanvas" aria-label="Close" ></button>
  </div>
